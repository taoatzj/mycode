					...
					function updateStatus()
					{
						if(null!=settings.statusText){
							...
							if(charactersLeft < 0) 
							{
								...
								item.next("div").html("限"+settings.maxCharacters+"字以内，你还可以输入"+charactersLeft + "" + settings.statusText);
						}
					}
...
//			//dataValidate:表单元素的验证规则，dataValidateJson为验证规则转化成的JSON
//			var dataValidate = null,dataValidateJson = null;
...
//							return false;
			...
			if(null!=JQObj.next().attr("class")&&JQObj.next().attr("class")=="prompt perror"){
				...
				if(errorInfo[tempCurrentName]!=null&&typeof(errorInfo[tempCurrentName])=="string"){
					...
					JQObj.after('<span class="prompt perror">输入信息不正确</span>');
				}
